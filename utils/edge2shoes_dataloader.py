...
class Edge2ShoesDataLoader(object):
    ...
    def __init__(self, data_root, batch_size, train_num_workers, transforms=None, test_num_workers=0):
        ...
        self.train_dataset = Edge2ShoesDataSet(train_image_list, transforms=transforms)
        self.test_dataset = Edge2ShoesDataSet(test_image_list, transforms=transforms)
...
class Edge2ShoesDataSet(Dataset):
    ...
    def __init__(self, data, transforms=None):
        super(Edge2ShoesDataSet, self).__init__()
